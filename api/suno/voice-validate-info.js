/**
 * Suno Voice: poll validation phrase — GET /api/v1/voice/validate-info?taskId=
 */
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const upstream = await sunoJsonRequest("/api/v1/voice/validate-info", {
      method: "GET",
      apiKey,
      query: { taskId },
    });
    ...
    if (!upstream.ok) {
      const msg =
        ...
        upstream.data?.error ||
        "Could not fetch validation phrase";
    ...
    return sendJson(res, 200, {
      ...
      validateInfo: String(d.validateInfo || ""),
