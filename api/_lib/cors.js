...
function applyCors(req, res) {
  ...
  res.setHeader(
    ...
    "Content-Type, Authorization, apikey, x-client-info, X-Nabad-Client-Shell, x-vercel-protection-bypass, X-Nabad-Title, X-Nabad-Fast, X-Nabad-Audio-Name, X-Nabad-Image-Url"
  );
