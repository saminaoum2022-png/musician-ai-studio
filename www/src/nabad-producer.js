...
import { NABAD_PRODUCER_PUBLIC_SHIPPED } from "./feature-flags.js";
...
function clientProducerUiBaked() {
  try {
    return Boolean(window.__NABAD_CLIENT_ENV__?.nabadProducerUi);
  } catch {
    return false;
  }
}
