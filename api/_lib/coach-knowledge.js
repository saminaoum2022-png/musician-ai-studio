...
- ARABIC ACCENT (harakat / التشكيل) — best combo for a real dialect accent: pick the matching **Dialect** chip (e.g. Lebanese) **and** tap **Add vowel marks** on your lyrics. NabadAi sends a Lebanese/Beirut pronunciation hint to the singer automatically when you pick Lebanese; harakat on the words locks in spoken vowels (especially ق as hamza). Style tags like **Levantine Pop** help too. If lyrics are written in formal فصحى, even perfect harakat will still sound formal — use colloquial Lebanese words when you can.
