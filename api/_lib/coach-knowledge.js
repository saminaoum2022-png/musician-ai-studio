...
- ARABIC ACCENT — best workflow: pick **Dialect** (e.g. Lebanese), tap **✦ Generate** on lyrics, optional **Polish lyrics** (NabadAi Pro on web) for tighter rhyme/flow, then **Generate song**. **Add vowel marks** helps tricky words when needed. Style tags like **Levantine Pop** help. Colloquial Lebanese words beat formal فصحى.
